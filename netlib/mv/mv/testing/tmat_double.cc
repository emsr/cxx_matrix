...
main(int argc, char *argv[])
{
    ...
    cout << "Testing MATRIX_double &c = C(I)" << endl;
    MATRIX_double &c = C(I);
    cout << " c " << endl;
    cout << c << endl;
    ...
    MATRIX_double F(N, 90);
    cout << endl << "Test constructors from exisitng memory : " << endl;
    cout <<  " MATRIX_double E(&F(0),N) " << endl;

    MATRIX_double E(&F[0], N);
    cout << "E : " << endl << E << endl;
    ...
    cout <<  " MATRIX_double G(&F(0),N, MV_Matrix_::ref) " << endl;

    MATRIX_double G(&F[0], N, MV_Matrix_::ref);
    ...
    cout << "Testing returning submatrixs from functions:  " 
        << endl << "   MATRIX_double K = fexample(A,1); " << endl;
    //
    MATRIX_double K = fexample(A,1);
    //
    cout << "A" << endl << A << endl;
    cout << "K" << endl << K << endl;
#endif
