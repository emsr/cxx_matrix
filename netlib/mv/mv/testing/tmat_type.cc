...
main(int argc, char *argv[])
{
    ...
    cout << "Testing MATRIX_TYPE &c = C(I)" << endl;
    MATRIX_TYPE &c = C(I);
    cout << " c " << endl;
    cout << c << endl;
    ...
    cout <<  " MATRIX_TYPE G(&F(0),N, MV_Matrix_::ref) " << endl;

    MATRIX_TYPE G(&F[0], N, MV_Matrix_::ref);
    ...
    cout << "Testing returning submatrixs from functions:  " 
        << endl << "   MATRIX_TYPE K = fexample(A,1); " << endl;
    //
    MATRIX_TYPE K = fexample(A,1);
    //
    cout << "A" << endl << A << endl;
    cout << "K" << endl << K << endl;
#endif
