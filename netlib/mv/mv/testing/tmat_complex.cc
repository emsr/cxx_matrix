...
main(int argc, char *argv[])
{
    ...
    cout << "Testing MATRIX_complex &c = C(I)" << endl;
    MATRIX_complex &c = C(I);
    cout << " c " << endl;
    cout << c << endl;
    ...
    MATRIX_complex F(N, 90);
    cout << endl << "Test constructors from exisitng memory : " << endl;
    cout <<  " MATRIX_complex E(&F(0),N) " << endl;

    MATRIX_complex E(&F[0], N);
    cout << "E : " << endl << E << endl;
    ...
    cout <<  " MATRIX_complex G(&F(0),N, MV_Matrix_::ref) " << endl;

    MATRIX_complex G(&F[0], N, MV_Matrix_::ref);
    ...
    cout << "Testing returning submatrixs from functions:  " 
        << endl << "   MATRIX_complex K = fexample(A,1); " << endl;
    //
    MATRIX_complex K = fexample(A,1);
    //
    cout << "A" << endl << A << endl;
    cout << "K" << endl << K << endl;
#endif
