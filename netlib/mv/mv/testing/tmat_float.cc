...
main(int argc, char *argv[])
{
    ...
    cout << "Testing MATRIX_float &c = C(I)" << endl;
    MATRIX_float &c = C(I);
    cout << " c " << endl;
    cout << c << endl;
    ...
    cout <<  " MATRIX_float E(&F(0),N) " << endl;

    MATRIX_float E(&F[0], N);
    cout << "E : " << endl << E << endl;
    ...
    cout <<  " MATRIX_float G(&F(0),N, MV_Matrix_::ref) " << endl;

    MATRIX_float G(&F[0], N, MV_Matrix_::ref);
    ...
    cout << "Testing returning submatrixs from functions:  " 
        << endl << "   MATRIX_float K = fexample(A,1); " << endl;
    //
    MATRIX_float K = fexample(A,1);
    //
    cout << "A" << endl << A << endl;
    cout << "K" << endl << K << endl;
#endif
