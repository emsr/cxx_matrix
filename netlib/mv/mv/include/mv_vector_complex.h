...
{                                                                      
    ...
    MV_Vector_complex(unsigned int, const complex&);   // can't be inlined 
                                                     //because of 'for'
                                                    // statement.
    MV_Vector_complex(complex*, unsigned int);      // new copy
    MV_Vector_complex(const complex*, unsigned int);        // new copy ???
    
    // reference of an exisiting data structure
    //
    MV_Vector_complex(complex*, unsigned int, MV_Vector_::ref_type i);  
