...
{                                                                      
    ...
    MV_Vector_int();                             
    MV_Vector_int(unsigned int);                             
    MV_Vector_int(unsigned int, const int&);   // can't be inlined 
                                                     //because of 'for'
                                                    // statement.
    MV_Vector_int(int*, unsigned int);      // new copy
    MV_Vector_int(const int*, unsigned int);        // new copy ???
    
    // reference of an exisiting data structure
    //
    MV_Vector_int(int*, unsigned int, MV_Vector_::ref_type i);  
...
//    inline                operator const  int*() const {return p_;} 
    ...
    friend ostream& operator<<(ostream &s, const MV_Vector_int &A);
